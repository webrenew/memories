          ...
          try {
            ...
            if (!effectiveSkipWorkspace && opts.workspace) {
              ...
              const choices = [
                ...
                ...organizations.map((org: SetupOrganization) => ({
              ...
              if (selectedWorkspace === PERSONAL_WORKSPACE_VALUE) {
                ...
                const selectedOrg = organizations.find((org: SetupOrganization) => org.id === selectedWorkspace);
                if (selectedOrg) {
                  target = {
