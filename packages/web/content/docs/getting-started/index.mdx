...
<Callout>
**Why npm?** The CLI uses native modules for AI-powered semantic search. npm handles native module builds more reliably than pnpm/bun for global installs. The semantic search model (~100MB) downloads on first use and runs entirely locally.
</Callout>
