...
For web-based tools like v0 that connect over HTTP:
...
For remote tools, expose your local server:
...
Then configure the remote tool to connect to the tunnel URL.
