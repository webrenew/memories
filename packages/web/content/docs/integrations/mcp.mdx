---
title: MCP Server
description: Connect memories.sh to any MCP-compatible AI assistant.
---

memories.sh provides a cloud MCP server that gives your AI assistants persistent memory across all your projects and devices.
...
Get your API key from the [dashboard](/app/settings). This key connects your AI tools to your personal memory database.
...
<Callout type="warn">
**Replace** `REPLACE_WITH_YOUR_API_KEY` with your actual API key from the [dashboard](/app/settings).
</Callout>
