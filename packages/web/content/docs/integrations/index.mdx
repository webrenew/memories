...
| [OpenClaw](/docs/integrations/openclaw) | `~/.openclaw/workspace/AGENTS.md` + `~/.openclaw/workspace/skills/` | No | Yes (workspace/CLI detection) |
...
| Workspace artifacts | OpenClaw | `~/.openclaw/workspace/AGENTS.md` + `~/.openclaw/workspace/skills/**/*` |
