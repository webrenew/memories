...
| [OpenCode](/docs/integrations/opencode) | `AGENTS.md` / `.opencode/instructions.md` | Yes | Yes |
| [Factory (Droid)](/docs/integrations/factory) | `.factory/instructions.md` | Yes | Yes |
...
The `agents` target (`AGENTS.md`) works with multiple tools that read the AGENTS.md convention:
- Amp
- Codex  
- Goose
- Kilo
...
Then configure the tool to connect to `http://localhost:3030/sse`. See the [v0 integration guide](/docs/integrations/v0) for details.
