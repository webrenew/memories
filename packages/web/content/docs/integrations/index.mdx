...
| [OpenClaw](/docs/integrations/openclaw) | `~/.openclaw/workspace/{AGENTS,SOUL,TOOLS,IDENTITY,USER,HEARTBEAT,BOOTSTRAP}.md` + skills/memory | No | Yes (workspace/CLI detection) |
