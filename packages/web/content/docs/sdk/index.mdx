...
These lifecycle hint fields are interpreted by `@memories.sh/core` when it builds context. They are
not part of the raw `POST /api/sdk/v1/context/get` HTTP request contract.
